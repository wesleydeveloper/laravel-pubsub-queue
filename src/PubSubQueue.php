...
class PubSubQueue extends Queue implements QueueContract
{
    ...
    /**
     * Get the number of pending jobs for the queue.
     * PubSubClient has no method to retrieve this data.
     *
    ...
    /**
     * Get the number of delayed jobs for the queue.
     * PubSubClient has no method to retrieve this data.
     *
     * @param  string|null  $queue
     * @return int
    ...
    /**
     * Get the number of reserved jobs for the queue.
     * PubSubClient has no method to retrieve this data.
     *
     * @param  string|null  $queue
     * @return int
